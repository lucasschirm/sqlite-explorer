    ...
    <div className="max-w-4xl mx-auto px-6 py-10">
      ...
      <nav className="mt-6 p-4 rounded-lg bg-gray-50 border border-gray-200">
        <ul className="grid grid-cols-2 sm:grid-cols-3 gap-x-4 gap-y-1.5 text-sm">
          {TOC.map(([id, label]) => (
            <li key={id}>
              <a href={siteUrl(`/docs?${id}`)} className="text-blue-600 hover:underline">
                {label}
              </a>
            </li>
          ))}
      ...
      <Section id="browsing-tables" title="Browsing tables">
        ...
        <p>
          ...
          table's <a href={siteUrl("/docs?structure-tab")} className="text-blue-600 hover:underline">Structure</a>{" "}
          tab directly.
        </p>
